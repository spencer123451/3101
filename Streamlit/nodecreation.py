...
GRAPHRAG_FOLDER = ''
NEO4J_URI="neo4j+s://d5ed894c.databases.neo4j.io" # or neo4j+s://xxxx.databases.neo4j.io 
...
doc_df = pd.read_parquet(r'D:\Graphrag1\20241023-112542\artifacts\create_final_documents.parquet', columns=["id", "title"])
